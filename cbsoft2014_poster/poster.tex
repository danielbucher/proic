...
\title{\huge\bfseries\hspace*{-1em} Rede de colaboração social para universidades brasileiras: um estudo de caso de implantação e desenvolvimento distribuído de uma plataforma livre na Universidade de Brasília}
\date{}
\author{\large Daniel Bucher
  \and Paulo Meirelles
}
\institute[UnB]{Faculdade do Gama, Universidade de Brasília, Brasil}
...
%\vfill
\begin{block}{Resumo}
  Este Trabalho de Conclusão de Curso tem como objetivo disponibilizar
  para a Universidade de Brasília (UnB) um ambiente virtual que
  permita e incentive a criação e o compartilhamento de conhecimento.
  
  Para disponibilizar essa plataforma, foi utilizado a plataforma livre
  para criação de redes sociais, Noosfero. Foram desenvolvidas algumas
  funcionalidades visando melhor adequar a plataforma ao ambiente de uma
  universidade. Além disso, todo o conhecimento adquirido durante esse
  processo foi repassado a uma equipe de alunos da Faculdade do Gama
  (UnB Gama) visando a continuidade do trabalho.
  
  A rede de colaboração resultante deste trabalho, chamada
  \textbf{Comunidade.UnB}, possui hoje 383 usuários e 30 comunidades.
\end{block}

%-------------------------------------------------------------------------------
\vfill
\begin{block}{Por que uma Rede Social da Univerdidade?}
	\begin{itemize}
